...
const { usersAll, userByName,userById, postUser, deleteUser, Updateuser, FollowMe, uploadI, notification, UpdateProfile  } =require('../controllers/usuario.controller')
...
router.put('/updateProfile', isAuth,uploadI, UpdateProfile);
